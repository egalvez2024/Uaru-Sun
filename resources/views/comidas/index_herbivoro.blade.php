...
@section('content')
    ...
    <a href="{{ route('fauna.index') }}" class="btn btn-success w-100 w-md-auto">Regresar</a>
</div>
        ...
        <div style="background: rgba(8, 219, 103, 0.19); font-size: 20px; padding: 20px">
            ...
            <div class="ecosystem">
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <img src="https://www.wearewater.org/wp-content/uploads/2024/03/maxresdefault-2024-03-01T081618.961.jpg" alt="Desiertos" class="img-fluid w-100 mb-3" style="max-height: 300px; object-fit: cover;">
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <img src="https://concepto.de/wp-content/uploads/2018/10/sabana1-e1539982728250.jpg" alt="Desiertos" class="img-fluid w-100 mb-3" style="max-height: 300px; object-fit: cover;">
                    </div>
                    <div class="col-12 col-md-8">
                        <p class="text-white text-justify" style="margin-bottom: 80px">
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <img src="https://concepto.de/wp-content/uploads/2019/07/bosque-templado-ecosistema-e1564522908407.jpg" alt="Desiertos" class="img-fluid w-100 mb-3" style="max-height: 300px; object-fit: cover;">
                    </div>
