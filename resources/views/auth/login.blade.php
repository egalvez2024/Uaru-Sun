<x-guest-layout>
<div class="min-h-screen flex items-center justify-center bg-no-repeat bg-center" 
     style="background-image: url('{{ asset('images/fonds.jpg') }}'); background-size: cover; background-position: top;">
        <div class="bg-opacity-80 bg-green-700 p-8 rounded-lg shadow-lg w-full max-w-sm text-white text-center">
            <div class="mb-4">
                <img src='images/logo.png' alt="" class="w-20 h-20 mx-auto">
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-left">
                    ...
                    <x-text-input id="email" class="block mt-1 w-full border-yellow-500 focus:border-yellow-700 focus:ring
                     focus:ring-yellow-300 text-gray-900" type="email" name="email" :value="old('email')" autofocus autocomplete="username" />
                ...
                <div class="mt-4 text-left">
                    ...
                    <x-text-input id="password" class="block mt-1 w-full border-yellow-500 focus:border-yellow-700 focus:ring focus:ring-yellow-300 text-gray-900"
                ...
                <div class="block mt-4 text-left">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-yellow-500 text-yellow-600 shadow-sm focus:ring-yellow-500" name="remember">
